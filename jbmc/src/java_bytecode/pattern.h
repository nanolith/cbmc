...
#ifndef CPROVER_JAVA_BYTECODE_JAVA_BYTECODE_PATTERN_H
#define CPROVER_JAVA_BYTECODE_JAVA_BYTECODE_PATTERN_H
...
#endif // CPROVER_JAVA_BYTECODE_JAVA_BYTECODE_PATTERN_H
